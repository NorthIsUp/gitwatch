 ...
 */
export declare class HumiditySensorPlatformAccessory extends BaseSensorPlatformAccessory<number> {
    ...
    updateCharacteristic(value: number): void;
    protected initialValue(): number;
}
//# sourceMappingURL=humiditySensorAccessory.d.ts.map